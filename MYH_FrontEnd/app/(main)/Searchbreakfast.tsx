...
export default function SearchBreakfast() {
    ...
    function handleAddMeal(selectedMeal) {
        ...
        router.push({pathname: "/(main)/AddMeal", 
            params: {
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <TextInput
                        ...
                        placeholder={searchText === '' ? 'Search Your Breakfast' : ''}
                    ...
                    <FlatList<MealSuggestion>
                        ...
                        renderItem={({ item }): JSX.Element => (
                            <View style={{
                                ...
                                <TouchableOpacity onPress={() => handleAddMeal(item)}>
