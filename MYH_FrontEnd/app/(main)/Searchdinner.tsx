...
export default function SearchDinner() {
    ...
    function handleAddSnack(selectedMeal) {
        ...
        router.push({pathname: "/(main)/AddDinner", 
            params: {
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <TextInput
                        ...
                        placeholder={searchText === '' ? 'Search Your Dinner' : ''}
                    ...
                    <FlatList<MealSuggestion>
                        ...
                        renderItem={({ item }): JSX.Element => (
                            <View style={{
                                ...
                                <TouchableOpacity onPress={() => handleAddSnack(item)}>
